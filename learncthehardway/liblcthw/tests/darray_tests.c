...
char *test_new()
{
	...
	mu_assert(val1 != NULL, "fail to make a new element.");

	val2 = DArray_new(array);
	mu_assert(val2 != NULL, "fail to make a new element.");
...
char *test_expand_contract()
{
	...
	DArray_expand(array);
	mu_assert((unsigned int)array->max == array->expand_rate + old_max, "Wrong size after expand.");
